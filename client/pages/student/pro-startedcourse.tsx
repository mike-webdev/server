...
export default function ProStartedCourse() {
            ...
            <section className="p-course-banner">
                <div className="container">
                    ...
                    <div className="col-sm-6">
                        ...
                        <img
                            className="img-fluid"
                            src="https://images.pexels.com/photos/1340588/pexels-photo-1340588.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"
                            alt="Course Image"
                        />
                        </div>
                    </div>
                    <div className="col-sm-6">
                        ...
                        <div>
                            ...
                            <h4 className="mt-2">
                            Learn IELTS. Begin here. Do this and that and that and this.
                            </h4>
                            <br />
